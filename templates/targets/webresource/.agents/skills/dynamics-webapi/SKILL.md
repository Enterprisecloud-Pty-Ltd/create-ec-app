...
```bash
python3 .agents/skills/dynamics-webapi/scripts/dynamics_api.py <org-url-or-host> <action> [resource]
```

Run the command from the repository root. On Windows use `python` or `py` with the same project-relative script path.
...
```bash
python3 .agents/skills/dynamics-webapi/scripts/dynamics_api.py contoso.crm.dynamics.com whoami
python3 .agents/skills/dynamics-webapi/scripts/dynamics_api.py contoso.crm.dynamics.com get 'accounts?$select=name,accountid&$orderby=createdon desc&$top=5'
python3 .agents/skills/dynamics-webapi/scripts/dynamics_api.py contoso.crm.dynamics.com get 'accounts(00000000-0000-0000-0000-000000000000)?$select=name'
python3 .agents/skills/dynamics-webapi/scripts/dynamics_api.py contoso.crm.dynamics.com metadata account
```
